function HorizontalFeatureCard({
  ...
  return (
    <div className="font-poppins hover:bg-foundation-gray-light text-shadow-light-gray flex gap-[54.36px] rounded-[16.09px] px-[22.11px] py-[16.09px] transition-colors duration-300 ease-out">
      <div>
