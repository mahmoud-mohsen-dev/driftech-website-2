...
function HeroSection() {
  return (
    <div className="min-h-screen bg-[url('../assets/background/3d-car-vibrant-city-night-1.png')] bg-cover bg-center pt-[calc(105px+75px)]">
      <section className="mx-auto h-full w-full max-w-[1221px]">
        <div className="text-foundation-gray-lighter font-inter flex max-w-[649px] flex-col items-start gap-12">
          ...
          <div className="ml-[1px] flex w-full items-center gap-[34.25px]">
            <Anchor href="#" isDefault={true}>
              Create Account
            </Anchor>
            <Anchor href="#" isDefault={false}>
              Create Account
            </Anchor>
          </div>
        </div>
